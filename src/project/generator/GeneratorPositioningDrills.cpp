...
void GeneratorPositioningDrills::CopyParameterFrom(const Generator * other)
{
	...
	wxLogMessage
	(wxString::Format(_T("CopyFrom: %i"), selectedPattern));
}
		...
		DisplaySettings* settings)
{
	...
	m_radioBox = new wxRadioBox(panel, wxID_ANY,
			wxT("Change drill positioning"), wxDefaultPosition, wxDefaultSize,
			m_radioBoxNChoices, m_radioBoxChoices, 1, wxRA_SPECIFY_COLS);
